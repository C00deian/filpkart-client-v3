  ...
  return (
    <header className="bg-primary sticky top-0 z-50 shadow-md">
      <div className="max-w-[1200px] mx-auto px-4 h-14 flex items-center gap-4">
        {/* Logo */}
        <Link to={ROUTES.HOME} className="flex-shrink-0 flex flex-col leading-none">
          <span className="italic font-bold text-xl text-white tracking-tight">Flipkart</span>
        ...
        <nav className="hidden md:flex items-center gap-6 ml-2 flex-shrink-0">
          <UserMenu />
          <Link to={ROUTES.CART} className="flex items-center gap-1.5 text-white text-sm font-medium relative">
