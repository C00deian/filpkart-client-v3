  ...
  return (
    <section className="bg-white rounded-sm shadow-card">
      <div className="flex items-center justify-between p-4 border-b border-slate-100">
        <h2 className="text-fluid-xl font-bold text-slate-900">Deal of the Day</h2>
        <Link
          to={ROUTES.PRODUCTS}
      ...
      <div className="p-4 grid-auto-fill-card gap-4">
        {isLoading
          ...
          : products?.slice(0, 5).map((p) => (
            ...
            >
              ...
              <p className="text-fluid-base font-medium text-slate-800 line-clamp-2 leading-snug">
                {p.name}
              </p>
