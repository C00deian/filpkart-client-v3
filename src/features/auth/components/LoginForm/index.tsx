    ...
    <div className="flex min-h-[calc(100vh-64px)] items-center justify-center bg-bg-main px-4 py-10">
      ...
      <div className="flex-1 flex flex-col justify-between p-8 md:p-10">
          ...
          <div className="flex flex-col gap-3">
            <button type="button"
              ...
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
                <path d="M23.766 12.276C23.766 11.461 23.7 10.641 23.559 9.838H12.24V14.459H18.722C18.453 15.949 17.589 17.268 16.323 18.106V21.104H20.19C22.461 19.014 23.766 15.927 23.766 12.276Z" fill="#4285F4"/>
                <path d="M12.24 24C15.477 24 18.206 22.938 20.195 21.104L16.328 18.106C15.252 18.838 13.863 19.252 12.245 19.252C9.113 19.252 6.459 17.14 5.507 14.3H1.516V17.391C3.553 21.443 7.703 24 12.24 24Z" fill="#34A853"/>
                <path d="M5.503 14.3C5.003 12.81 5.003 11.196 5.503 9.706V6.615H1.517C-0.186 10.006 -0.186 14 1.517 17.391L5.503 14.3Z" fill="#FBBC05"/>
                <path d="M12.24 4.75C13.951 4.723 15.604 5.367 16.843 6.549L20.269 3.123C18.1 1.086 15.221 -0.034 12.24 0.001C7.703 0.001 3.553 2.558 1.516 6.615L5.502 9.706C6.45 6.862 9.109 4.75 12.24 4.75Z" fill="#EA4335"/>
              </svg>
        ...
        <div className="mt-8 text-center pt-4 border-t border-slate-100">
          <Link to={ROUTES.REGISTER} className="text-primary text-sm font-semibold hover:underline">
